...
Once the `conda-forge` channel has been enabled, `plateau` can be installed with:

```
conda install plateau
```

It is possible to list all of the versions of `plateau` available on your platform with:
